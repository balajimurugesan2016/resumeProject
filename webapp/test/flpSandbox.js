		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Resume",
									"targetURL": "#resumemodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"resumemodule-display": {
								"semanticObject": "resumemodule",
								"action": "display",
								"description": "Balaji Vengatesh Murugesan Resume",
								"title": "Resume",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=resumemodule",
									"url": sap.ui.require.toUrl("resumemodule")
								}
							}
						}
					}
